...
//async.parallel([renfeRequest, excelRequest], esHoraDeIrse);



var renfeRequest = request(renfeUrl, function (error, response, body) {
    //parser.write(body);
...
var excelRequest = request(myExcelJson, function (error, response, body) {
